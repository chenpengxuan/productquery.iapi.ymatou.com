...
public class HistoryProductModel {
    ...
    private double MaxCatalogPrice;
    private double MinCatalogPrice;
    ...
    public double getMaxCatalogPrice() {
        return MaxCatalogPrice;
    }

    public void setMaxCatalogPrice(double maxCatalogPrice) {
        MaxCatalogPrice = maxCatalogPrice;
    }

    public double getMinCatalogPrice() {
        return MinCatalogPrice;
    }

    public void setMinCatalogPrice(double minCatalogPrice) {
